...
export const STANDARD_CATEGORIES: Omit<Category, 'id'>[] = [
  ...
  { name: 'Capital Inflow', icon: 'banknote', color: '#34D399', type: 'income', subcategories: [{ name: 'Regular Salary', icon: 'banknote' }, { name: 'Performance Bonus', icon: 'sparkles' }] },
  ...
  { name: 'Residence', icon: 'home', color: '#F59E0B', type: 'expense', subcategories: [{ name: 'Rent', icon: 'home' }, { name: 'Utilities', icon: 'settings' }] }
];

export const ELITE_UPGRADES: Record<string, Partial<Category>> = {
  'Shopping': { name: 'Luxury Assets', subcategories: [{ name: 'Timepieces', icon: 'award' }, { name: 'High Jewelry', icon: 'diamond' }, { name: 'Couture', icon: 'shopping_bag' }] },
  'Electronics': { name: 'Premium Tech', subcategories: [{ name: 'Hardware', icon: 'smartphone' }, { name: 'Private Software', icon: 'code' }, { name: 'Advanced Gadgets', icon: 'cpu' }] },
  'Food & Drinks': { name: 'Gastronomy', subcategories: [{ name: 'Michelin Star', icon: 'star' }, { name: 'Private Chef', icon: 'utensils' }, { name: 'Vintage Spirits', icon: 'glass-water' }] },
  'Travel': { name: 'Private Travel', subcategories: [{ name: 'Aviation', icon: 'plane' }, { name: 'Executive Lounge', icon: 'sofa' }, { name: 'Exclusive Resorts', icon: 'palmtree' }] },
  'Savings': { name: 'Capital Allocation', subcategories: [{ name: 'Equities', icon: 'bar-chart' }, { name: 'Real Estate', icon: 'building' }, { name: 'Digital Assets', icon: 'bitcoin' }] },
